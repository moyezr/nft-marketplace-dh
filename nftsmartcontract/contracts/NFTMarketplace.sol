...
modifier onlyOwner {
    ...
    "only owner of the market place can perform this action");
    _;
}
...
// If someone is purchasing something from my NFT Marketplace, then he/she should pay some fees for listing the NFT. 
